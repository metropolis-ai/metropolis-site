...
In a Gallup survey this May, 39% of Americans said AI does more harm than good, up from 31%. Only 27% trust businesses to use it responsibly.
...
In May 2025, Anthropic's CEO, Dario Amodei, told Axios that AI could eliminate half of all entry-level white-collar jobs within five years. Taking over that work would mean doing it reliably, and the tools still make things up, even in white-collar work like law. A public database kept by researcher Damien Charlotin lists 2,041 court decisions in which a party relied on content an AI made up. In a Stanford test, legal research tools sold as "hallucination-free" made things up between 17% and 33% of the time.

## "Just use AI"

Inside companies, the promise often arrives as an instruction: just use AI. Meta made "AI-driven impact" a core expectation in its 2026 performance reviews, and some employees reportedly ran AI agents for hours to climb an internal token leaderboard. In April, Duolingo's CEO dropped AI usage from performance reviews, saying that "rather than being held accountable for the actual outcome, we're trying to just push something that in some cases did not fit."

The results show it. In an NBER survey published in February, 69% of firms said they use AI, but nine in ten executives reported no impact on productivity or employment over the past three years.

## Why so many projects stall

A large language model, or LLM, is the kind of AI behind chatbots like ChatGPT and Claude, and it is what most people mean by AI today. It is trained on huge amounts of text to predict likely words, which makes it a language tool. It is also probabilistic. Traditional software gives the same output for the same input. An LLM gives a likely answer, and the likely answer can change. Researchers at Thinking Machines ran one prompt 1,000 times with settings meant to make the output identical and got 80 different answers.

Its abilities are uneven, too. Stanford's 2026 AI Index reports that an AI system won gold at the International Mathematical Olympiad, while the best model read analog clocks correctly only 50.6% of the time. In a randomized experiment with 758 BCG consultants, AI raised quality by roughly 30% on tasks it handled well, and made consultants 19 percentage points less likely to reach the right answer on a task it didn't.
...
Financially, it may be. In June, the Bank for International Settlements compared AI investment to railway mania and the dot-com boom, breakthroughs that "attracted capital in excess of what commercial returns could ultimately justify." It also found that AI saves 20% to 50% of the time on individual tasks, while estimates of economy-wide productivity gains are under 1%. The hype was built on genies. We think the lasting value will come from the systems that put these tools to work.
